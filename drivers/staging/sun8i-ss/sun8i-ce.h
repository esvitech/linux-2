...
/* SS Method A83T */
#define SS_OP_AES		0
#define SS_OP_DES		(1 << 2)
#define SS_OP_3DES		(2 << 2)
#define SS_OP_MD5		(3 << 2)
#define SS_OP_PRNG		(4 << 2)
#define SS_OP_TRNG		(5 << 2)
#define SS_OP_SHA1		(6 << 2)
#define SS_OP_SHA224		(7 << 2)
#define SS_OP_SHA256		(8 << 2)
